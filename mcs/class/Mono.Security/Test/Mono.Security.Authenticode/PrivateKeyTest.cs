...
public class PrivateKeyTest {
	...
	public void MSNoPassword ()
	{
		...
		Assert.NotNull (pvk.RSA, "msnopwd.RSA");
	...
	public void ConvertToPasswordWeak () 
	{
		...
		Assert.NotNull (pvk.RSA, "topwd.RSA");
	...
	public void MSPasswordWeak () 
	{
		...
		Assert.NotNull (pvk.RSA, "mspwd.RSA");
	...
	public void RemovePassword () 
	{
		...
		Assert.NotNull (pvk.RSA, "nomorepwd.RSA");
		string rsa2 = pvk.RSA.ToXmlString (true);
	...
	public void CreatePVK () 
	{
		...
		Assert.NotNull (pvk.RSA, "new.RSA");
		string rsa2 = pvk.RSA.ToXmlString (true);
