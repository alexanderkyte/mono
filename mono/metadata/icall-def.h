...
HANDLES(ICALL(RUNTIME_14, "DumpStateSingle_internal", ves_icall_Mono_Runtime_DumpStateSingle))
HANDLES(ICALL(RUNTIME_15, "DumpStateTotal_internal", ves_icall_Mono_Runtime_DumpStateTotal))
...
HANDLES(ICALL(RUNTIME_16, "RegisterReportingForNativeLib_internal", ves_icall_Mono_Runtime_RegisterReportingForNativeLib))
