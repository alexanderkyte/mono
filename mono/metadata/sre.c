...
static gboolean reflection_create_class_hierarchy (MonoReflectionTypeBuilderHandle tb, GHashTable *unparented, MonoError *error);
...
static gboolean
reflection_setup_class_hierarchy (MonoReflectionTypeBuilderHandle ref_tb, GHashTable *unparented, MonoError *error)
{
	HANDLE_FUNCTION_ENTER ();
	mono_error_init (error);
...
reflection_setup_internal_class (MonoReflectionTypeBuilderHandle ref_tb, MonoError *error)
{
	...
	if (unparented_classes) {
		...
		reflection_setup_class_hierarchy (ref_tb, unparented_classes, error);
		mono_error_assert_ok (error);
